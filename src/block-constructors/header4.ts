...
export const Header4Rule: BlockConstructor<Header4Block> = {
  compile: ([primaryInput], { configuration }, messages, wholeTokens) => {
    ...
    return new Header4Block(primaryInput, anchor);
  },
  name: '####',
  namespace: 'std'
};

export class Header4Block extends RenderableBlock {
  constructor(public readonly text: string, public readonly anchor?: string) {
    super();
  }
  public debug(): string {
    return `Header4(${this.text})`;
  }
}
